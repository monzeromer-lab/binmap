# Lodestone — Binary Toolchain Reference
...
sweeping linearly. For Lodestone, function-bounded decoding is sufficient — you always know
...
struct LodeSymbols { by_addr: BTreeMap<u64, String> }

impl SymbolResolver for LodeSymbols {
